...
if os.path.exists("/home/ubuntu/ids_lab/HLMCC_python/Graphs") == False:
    os.makedirs('/home/ubuntu/ids_lab/HLMCC_python/Graphs')
...
while invalid == True:
    ...
    if option == '1':
        Data = pd.read_csv("/home/ubuntu/ids_lab/HLMCC_python/Datasets/original_Dataset/LWSNDR Single Hop Indoor.csv")
        Data.astype(float)
        if os.path.exists("/home/ubuntu/ids_lab/HLMCC_python/Graphs/LWSNDR Single Hop Indoor") == False:
            os.makedirs('/home/ubuntu/ids_lab/HLMCC_python/Graphs/LWSNDR Single Hop Indoor')
        base_results_dir = '/home/ubuntu/ids_lab/HLMCC_python/Graphs/LWSNDR Single Hop Indoor'
        xcolumn = 'Humidity'
        ycolumn = 'Temperature'
        name = 'LWSNDR Single Hop Indoor'
        invalid = False
    elif option == '2':
        Data = pd.read_csv("/home/ubuntu/ids_lab/HLMCC_python/Datasets/original_Dataset/LWSNDR Multi Hop Indoor.csv")
        Data.astype(float)
        if os.path.exists("/home/ubuntu/ids_lab/HLMCC_python/Graphs/LWSNDR Multi Hop Indoor") == False:
            os.makedirs('/home/ubuntu/ids_lab/HLMCC_python/Graphs/LWSNDR Multi Hop Indoor')
        base_results_dir = '/home/ubuntu/ids_lab/HLMCC_python/Graphs/LWSNDR Multi Hop Indoor'
        xcolumn = 'Humidity'
        ycolumn = 'Temperature'
        ...
        Data = pd.read_csv("/home/ubuntu/ids_lab/HLMCC_python/Datasets/original_Dataset/satellite.csv")
        if os.path.exists("/home/ubuntu/ids_lab/HLMCC_python/Graphs/satellite") == False: 
            os.makedirs('/home/ubuntu/ids_lab/HLMCC_python/Graphs/satellite')
        base_results_dir = '/home/ubuntu/ids_lab/HLMCC_python/Graphs/satellite'
        xcolumn = 'V1'
        ycolumn = 'V2'
        name = 'satellite'    
        invalid = False
        ...
        Data = pd.read_csv("/home/ubuntu/ids_lab/HLMCC_python/Datasets/original_Dataset/IoT_23_data.csv")
        Data = Data.astype(float)
        if os.path.exists("/home/ubuntu/ids_lab/HLMCC_python/Graphs/IoT_23_data") == False: 
            os.makedirs('/home/ubuntu/ids_lab/HLMCC_python/Graphs/IoT_23_data')
        base_results_dir = '/home/ubuntu/ids_lab/HLMCC_python/Graphs/IoT_23_data'
        xcolumn = 'Index'
        ycolumn = 'duration'
        name = 'IoT_23_data'    
        invalid = False
...
Data_merge.to_csv(f"/home/ubuntu/ids_lab/HLMCC_python/Datasets/clustered_Dataset/{name}.csv", index=False)
